...
import random, string #added for login generate key

#added for google and facebook login
...
APPLICATION_NAME = "Restaurant Menu Application"   #I used the same project as the Restarurant Menu project
...
def gconnect():
    ...
    # see if user exists, if it doesn't make a new one, added
...
def editGenre(genre_id):
    ...
    if editedGenre.user_id != login_session['user_id']:  
        return """
            <script>function myFunction() {alert('You are not authorized to edit this genre. 
            PLease create your own genre in order to edit.');}</script><body onload ='myFunction()''>
        """ 
...
def deleteGenre(genre_id):
    ...
    if genreToDelete.user_id != login_session['user_id']:  
        return """
            <script>function myFunction() {alert('You are not authorized to delete this genre. 
            PLease create your own genre in order to delete.');}</script><body onload ='myFunction()''>
        """
...
def showMovie(genre_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        return render_template('publicmovie.html', movies=movies, genre=genre, creator = creator)
    else:
        return render_template('movie.html', movies=movies, genre=genre, creator = creator)
...
def newMovie(genre_id):
    ...
    if login_session['user_id']!= genre.user_id:
        return """
        <script>function myFunction() {alert('You are not authorized to add movies to this genre. 
        PLease create your own genre in order to add movies.');}</script><body onload ='myFunction()''>
        """

    if request.method == 'POST':
        if request.form['name']:
            newMovie = Movie(name=request.form['name'], description=request.form['description'], director=request.form['director'], starring=request.form['starring'], genre_id=genre_id)
...
def editMovie(genre_id, movie_id):
    ...
    if login_session['user_id'] != genre.user_id:
        return """
        <script>function myFunction() {alert('You are not authorized to edit movies to this genre. 
        Please create your own genre in order to edit movies.');}</script><body onload='myFunction()''>
        """
    ...
    if request.method == 'POST':
        ...
        return render_template('editmovie.html', genre_id=genre_id, movie_id=movie_id, movie=editedMovie)
...
def deleteMovie(genre_id, movie_id):
    ...
    if login_session['user_id'] != genre.user_id:
        return """<script>function myFunction() {alert('You are not authorized to delete movies to this genre. 
        Please create your own genre in order to delete movies.');}</script><body onload='myFunction()''>
        """
    ...
    if request.method == 'POST':
        ...
        return render_template('deleteMovie.html', genre_id=genre_id, movie_id=movie_id, movie=movieToDelete)
